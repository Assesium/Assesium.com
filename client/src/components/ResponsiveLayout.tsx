    ...
    <div className="app-shell h-screen w-screen overflow-hidden p-2 md:p-4 transition-colors duration-300 box-border">
      <div className="glass-effect h-full w-full rounded-[40px] p-4 md:p-6 shadow-2xl relative overflow-hidden flex flex-col">
        ...
        <div className="relative z-10 flex h-full min-h-0 gap-6">
          <aside
            className={`route-sidebar shrink-0 flex-col transition-all duration-300 ${
              isMobileSidebarOpen
                ? 'fixed inset-y-2 left-2 z-[9999] translate-x-0 rounded-3xl p-3 shadow-2xl w-20 bg-white dark:bg-gray-900 overflow-y-auto max-h-[calc(100vh-1rem)] flex flex-col items-center pointer-events-auto'
                : isSidebarCollapsed
          ...
          >
            ...
            <nav className="space-y-2 w-full" aria-label="Main menu">
            ...
            <div className="mt-auto space-y-5 pt-8 w-full flex flex-col items-center">
              <button
              ...
              <div className={`relative border-t border-gray-200 pt-5 dark:border-gray-700 w-full flex flex-col items-center`}>
                <button
                  ...
                  className={`flex w-full items-center ${isMobileSidebarOpen || isSidebarCollapsed ? 'justify-center p-2' : 'gap-3 p-3 pr-11'} rounded-2xl bg-gray-50 text-left transition hover:bg-purple-50 dark:bg-gray-800 dark:hover:bg-gray-700`}
                >
